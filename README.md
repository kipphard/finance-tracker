...
standalone **Distribute a one-off amount** card with its own independent buckets that splits an
arbitrary windfall — bonus, gift, refund — across debt/emergency-fund/tax/planned off the top and
your own % buckets, booked immediately), emergency fund,
